...
ActiveRecord::Schema.define(version: 20180802150714) do
  ...
  create_table "game_highscores", id: :serial, force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "points", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_game_highscores_on_user_id"
  end
